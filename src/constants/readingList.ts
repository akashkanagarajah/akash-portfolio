...
export const READING_LIST: ShowcaseBook[] = [
  {
    ...
    author: "James Clear",
    status: "Finished",
    desc: "Picked it up for the argument that systems beat goals and it stuck. The part that changed how I work is that you don't rise to the level of your goals, you fall to the level of your systems. So I stopped setting targets and started designing the small daily loop instead.",
  ...
  },
  {
    ...
    status: "Finished",
    desc: "Read it expecting a finance book and got a behaviour book. The essays are short enough to put down easily and hard enough to forget slowly; the chapter on how much of a good outcome is luck and timing is the one I keep coming back to.",
